...
let questions = [
    ...
    answerOptions: [
    { answerText: "The office party", answerImage: 'https://valetcoffee.com/wp-content/uploads/2019/12/Office-Party-Ideas-that-dont-suck-Northern-Kentucky-Cincinnati.jpeg', nextIndex: 2, metric: 'danceability', value: -0.05 },
    ...
    { answerText: "John Mulaney", answerImage: 'https://www.insidehook.com/wp-content/uploads/2020/11/mulaney-snl.jpg?fit=1200%2C675', nextIndex: 8, metric: 'danceability', value: 0.1},
    ...
    { answerText: "dUCk", answerImage: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmF0F9ilFaGesRtUH4GvFr_uiZJSQSitDtvA&usqp=CAU', nextIndex: 9, metric: 'energy', value: 0.1},
    ...
    answerOptions: [
    { answerText: "Catchy chorus", answerImage: 'https://images.unsplash.com/photo-1518609878373-06d740f60d8b?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxzZWFyY2h8MXx8c29uZ3xlbnwwfHwwfA%3D%3D&auto=format&fit=crop&w=500&q=60', nextIndex: 10, metric: 'valence', value: 0.05},
    { answerText: "Unexpected beat drop", answerImage: 'https://images.unsplash.com/photo-1591557184386-e0e124abe0be?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxzZWFyY2h8NXx8dGVjaG5vfGVufDB8fDB8&auto=format&fit=crop&w=500&q=60', nextIndex: 10, metric: 'energy', value: 0.05},
    ...
    { answerText: "Drunk Dog Doug", answerImage: 'https://lefunny.net/wp-content/uploads/2014/05/Funny-party-animals-picture.jpg', nextIndex: null, metric: 'danceability', value: 0.1},
    ...
    { answerText: "Refined Rex", answerImage: 'https://blog.yellowoctopus.com.au/wp-content/uploads/2017/06/yellow-octopus-party-time-meme-2.jpg', nextIndex: null, metric: 'energy_range', value: -0.05},
    ],
    },
    {
    index: 11,
